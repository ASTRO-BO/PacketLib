...
//## to this class. The responsibility of delete the ByteStream is of the caller.
...
class Packet
{
    public:
        ...
        //## \post A side effects of this method is that the value of fields of packet are setted with
        //## correct value.
        ...
        //## contains a packet of this type. This method overloads another method.
        //## \post A side effect of this method is that the values of fields of packet are setted with
        //## correct value
        ...
        //## \post If return is true all the fields are setted with the correct value.
	...
	virtual char* getFileName() { return filename; }
        ...
        //##Documentation
        //## Whitin this ByteStrem is present prefix of packet.
        ByteStream* prefix;

	      //##ModelId=3EADC12A0382
        //##Documentation
        //## Whitin this ByteStrem is present the packet read
        ByteStream* packet;
